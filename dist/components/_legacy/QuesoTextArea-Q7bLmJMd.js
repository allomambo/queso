...
import '../../assets/components/QuesoTextArea.css';const k = { class: "queso-text-area" }, q = ["innerHTML"], B = ["name", "id", "value", "placeholder", "required", "autocomplete", "disabled", "onInput", "onMouseover", "onMouseleave", "onFocus", "onBlur"], T = /* @__PURE__ */ $({
